...
import { FaLinkedin, FaInstagram, FaEnvelope, FaStar, FaQuoteLeft } from "react-icons/fa";
import tim from "../../data/tim.json";

export default function TimKita() {
  return (
    <section id="tim" className="relative py-24 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 overflow-hidden">
